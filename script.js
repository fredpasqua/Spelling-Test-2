...
var grade4Words = [
  ...
  "metropolitan",
  "agriculture",
  "rural", "microscope", "microchip", "astrology", "megaphone",
  "apathy", "sympathy", "hydrate", "dehydrate", "mega", "megabit",
  "megastar", "astrologist", "astronaut", "hydrologist", "hydroplane",
  "hydrometer", "search", "church", "branches", "speeches", "beach", "teach", "crouch", "touch", "watches", "fetches", "catches", "dispatch", "choke", "cheerful", "churn", "chosen"];
...
function submit() {
  ...
  if (score === 100){
     ...
     document.getElementById('scoreContainer').innerHTML = (' ' + Math.round(score));
